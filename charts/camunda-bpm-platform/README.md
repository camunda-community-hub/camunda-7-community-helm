...
#### Debugging
Enable debugging in the Camunda BPM container by setting:
```yaml
general:
  debug: true
```
...
Each distro has different tags, check the list of [supported tags/releases](https://github.com/camunda/docker-camunda-bpm-platform#supported-tagsreleases) by Camunda BPM docker project for more details.
...
could be used as a database for Camunda BPM.
...
Enable Prometheus metrics for Camunda BPM by setting the following in the values file:
